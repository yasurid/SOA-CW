...
class customerController extends SimpleRest  
{
    public function setCustomer($custName,$custAddress,$custContactNo)
    {
        ...
        $rawData = $customerModelObj->setCustomer($custName,$custAddress,$custContactNo);
    ...
    public function getCustomer()
    {
        ...
        $customerModelObj = new customerModel(); 
        $rawData = $customerModelObj->getCustomer();
