...
<head>
  ...
  <meta name="author" content="Airport & Aviation Services (Sri Lanka) Limited">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="home.php" class="logo">
      ...
      <span class="logo-lg"><b>ABC Bank Portal</b></span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <input type="hidden"  id='txtEPF' name ='txtEPF' value="<?php echo $_SESSION['customerId']; ?>" />
